...
<div style=" text-align:center;">
    <form  method="POST" action="${pageContext.request.contextPath}/admin/AdminLogUpServlet"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select id="per" name="per" class="input-xlarge" title="">
                    <option>ADD ONLY</option>
                    <option>MODIFY ONLY</option>
